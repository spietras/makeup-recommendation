...
class MTCNN(LoadableModule):
    ...
    def __init__(self, min_face_size=20, thresholds=(0.6, 0.7, 0.7), factor=0.709):
        super().__init__()
    ...
    def forward(self, imgs):
        ...
        batch_boxes, batch_points = detect_face(imgs, self.min_face_size, self.pnet, self.rnet, self.onet,
                                                self.thresholds, self.factor, next(self.parameters()).device)
